...
\paragraph{3($\times256$) Nonuniform Boundary Conditions} The
...
into the file \verb!compiler!. If errors arise, then the
command \verb!$ make clean; make! will clean up and retry with the 
new default compiler, which will likely work.
