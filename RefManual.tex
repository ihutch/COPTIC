...
thermal spread of the neutrals is ignored in using this collision
setting, which is important only when \verb!En! is non-zero, at
present, since it is not yet implemented in the padvnc routine.
