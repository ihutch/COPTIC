...
state. The integer switch indicates 0: no restart; 1: read just the
particle and potential files so as to initialize, and start the step
count at 1; 2 [or usually 3]: read the flux file [and particle and
