...
species. By default this is equal to the square root of the inverse
mass ratio. The number of steps of this species per ion step is equal
to the number-ratio, so the number of depositions of electrons and
ions is equal (for the background).
Setting -nr1 uses equal numbers of particles and no substepping.
...
\item The particles are advanced by \verb!padvnc!. Charge deposition
  of species higher than 1 is integrated into this routine.
