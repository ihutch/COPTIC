...
distribution function at the separatrix. Its normal value is 0.6.
A typical usage is \verb!-ih.8,0,999,2.,999,0,.6!. The values 999 tell
the initialization to use preset values for \verb!holelen! and
\verb!holetoplen! (the same parameter as \verb!holepow! when using
quiet start \verb!-pi!).  
...
$-1/\psi$, while if \verb!holegfac!$\not=0$ then $4+\psi/10$ and
$\psi-1/\psi$ are used. These permit deep holes $\psi\gg1$ to be initialized.
