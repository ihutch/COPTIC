...
\paragraph{-spb...} Add an extra Boltzmann fraction $f_b$
(\verb!boltzamp!). This applies only when both electrons and ions are
being modelled as particles (more than one particle species is
present). It is physically equivalent to adding an additional species
whose density is equal to $f_be\phi/T_e$. That is, like linearized
Boltzmann electrons neutralized by an equal background density of
immobile positive charge. It is implemented through the function
\verb!faddlin!. The addition helps to stabilize long-wave-length
fluctuations in regions that are much larger than the Debye
length. The fraction required is of order the ratio of the Debye
...
drift approximation. The ion motion consists purely of two
...
velocity plus the explicit $E\times B$ drift.
