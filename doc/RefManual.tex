...
grid size to be somewhat smaller than the Debye length. [Not sorted out]
...
automatically, as it is normally by default. When running with a large
number of nodes to give high particle per cell count, it is helpful to
limit the number of blocks into which dimensions are split so as not
to obtain excessive interprocess communication demands. 
