...
\paragraph{-pi...} Reads an integer argument from the switch, which is
set equal to the maximum number of qblocks in each dimension, and if
greater than zero causes the qinit code to be used for particle
initialization. 
